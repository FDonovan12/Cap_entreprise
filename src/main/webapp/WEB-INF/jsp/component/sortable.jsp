...
<div class="sort-filter d-flex mt-4">
    ...
    <div class="ms-1 me-2 row">
        ...
        <a href="${jspUtils.getUrlFrom(currentUrl, currentQuery, sortAsc)}" data-my-sortable="${sortAsc}">
            <i class="fa-solid fa-sort-up"></i>
        </a>
        <c:set var="sortDesc" scope="request" value="sort=${sortable},desc"/>
        <a href="${jspUtils.getUrlFrom(currentUrl, currentQuery, sortDesc)}" data-my-sortable="${sortDesc}">
