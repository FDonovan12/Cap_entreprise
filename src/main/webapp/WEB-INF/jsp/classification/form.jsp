...
<c:set var="title" scope="request" value="formulaire de classification"/>
<jsp:include flush="true" page="${contextPath}/WEB-INF/jsp/base.jsp"/>

<h1>Formulaire de classification</h1>
<f:form modelAttribute="classification" method="post" action="${currentUrl}" cssClass="p-1 p-md-5">
    <div class="mb-3 row">
